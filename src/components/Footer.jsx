      ...
      <div className="footer-top">
        <div className="footer-brand">
          ...
          <div className="footer-social">
            <a
              href="https://instagram.com/taxidi_gnosis.angcor"
            ...
            <a
              href="https://instagram.com/zwevten_margadarsana"
              className="social-icon"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
            ...
            <a
              href="https://instagram.com/proast.vel_"
              className="social-icon"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
        ...
        <div className="footer-col">
          <h5>Informasi SMA IT Bunayya</h5>
          <a
